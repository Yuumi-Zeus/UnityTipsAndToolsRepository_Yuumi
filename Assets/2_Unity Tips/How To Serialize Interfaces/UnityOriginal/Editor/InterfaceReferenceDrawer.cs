...
namespace _2_Unity_Tips.How_To_Serialize_Interfaces.UnityOriginal.Editor
{
    ...
    public class InterfaceReferenceDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.BeginProperty(position, label, property);
            {
                ...
                OdinEditorGUIUtil.DrawRectOutlineWithBorder(rect, Color.yellow);
                var assignedObject = EditorGUI.ObjectField(position, label, sourceProperty.objectReferenceValue,
                    typeof(Object), true);
                rect = GUILayoutUtility.GetLastRect();
                OdinEditorGUIUtil.DrawRectOutlineWithBorder(rect, Color.red);
