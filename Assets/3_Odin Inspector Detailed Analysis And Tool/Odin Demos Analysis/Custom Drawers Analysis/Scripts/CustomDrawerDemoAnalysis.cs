...
namespace Odin_Demos_Analysis.Custom_Drawers_Analysis.Scripts
{
    ...
    public class CustomStructDrawer : OdinValueDrawer<MyStruct>
    {
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            OdinEditorGUIUtil.DrawRectOutlineWithBorder(rect, Color.red, 5);
            ...
            if (label != null)
            {
                ...
                OdinEditorGUIUtil.DrawRectOutlineWithBorder(prefixLabelRect, Color.yellow);
            ...
            OdinEditorGUIUtil.DrawRectOutlineWithBorder(rect, Color.green, 3);
            value.x = EditorGUI.Slider(rect.AlignLeft(rect.width * 0.5f), " X ", value.x, 0, 1);
            OdinEditorGUIUtil.DrawRectOutlineWithBorder(rect.AlignLeft(rect.width * 0.5f), Color.magenta, 0);
            value.y = EditorGUI.Slider(rect.AlignRight(rect.width * 0.5f), " Y ", value.y, 0, 1);
            OdinEditorGUIUtil.DrawRectOutlineWithBorder(rect.AlignRight(rect.width * 0.5f), Color.cyan, 0);
