...
namespace Sirenix.OdinInspector.Demos
{
    ...
    public class CUSTOM_ValuePriorityDrawer : OdinValueDrawer<MyClass>
    {
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            //     SirenixEditorFields.TextField(rect, new GUIContent("Custom Name"), ValueEntry.SmartValue.Name);
            // ValueEntry.Property.Children["Name"].Label = new GUIContent("自定义 LabelName");
    ...
    public class CUSTOM_Drawer : OdinValueDrawer<MyClass>
    {
        protected override void DrawPropertyLayout(GUIContent label)
        {
            Rect rect = UnityEditor.EditorGUILayout.GetControlRect();
            UnityEditor.EditorGUI.LabelField(rect, "Custom Label");
        }
    }
