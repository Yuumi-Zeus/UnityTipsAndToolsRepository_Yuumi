...
namespace Odin_Inspector_Detailed_Analysis_And_Tool.Attributes_Analysis.Debug.ShowDrawerChain.Scripts.Yuumi
{
    public class YuumiShowDrawerChainAnalysis : MonoBehaviour
    {
        ...
        void CustomGUI()
        {
            ...
            GUI.Label(rect,
                ...
                wordWrapLabelStyle);
            OdinEditorDrawUtil.OdinDebug.DrawRectOutlineWithBorder(rect, Color.red);
            var secondRect = GUILayoutUtility.GetLastRect();
            OdinEditorDrawUtil.OdinDebug.DrawRectOutlineWithBorder(secondRect, Color.cyan);
