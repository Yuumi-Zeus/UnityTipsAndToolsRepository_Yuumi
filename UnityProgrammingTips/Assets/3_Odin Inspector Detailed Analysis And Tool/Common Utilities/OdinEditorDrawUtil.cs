...
namespace Odin_Inspector_Detailed_Analysis_And_Tool.Common_Utilities
{
    ...
    public static class OdinEditorDrawUtil
    {
        ...
        public static class OdinDebug
        {
            ...
            /// <param name="borderWidth">外框线与实际 Rect 的边界的距离，默认为 1，即默认大一圈，该值不为外框线本身的厚度</param>
            public static void DrawRectOutlineWithBorder(Rect rect, Color outlineColor, float borderWidth = 1)
            {
                // 绘制边框
